...
随着前端技术的不断探索和谷歌浏览器的推广, 通过套壳也好, js2native也好js这门语言被赋予了生成客户端的能力, 让js在这几年大火了起来, 比如阿里的weex, fb的react-native都可以直接用原生js的语法生成原生应用. 还有微信小程序, 其代码就是js. 这里要特别说下weex和微信小程序的api都是按照vue来设计的, 也就是学会了vue, 学weex和小程序就会非常快. 之所以这2者在用vue的api也正式因为vue设计的api比较易懂上手快.
