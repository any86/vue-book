...
其实不止vue, 还有react和angular, 不管是时代使然, 还是国家的推动, 创业者越来越多, 基本每个创业团队都会有至少一款app, 以前都是ios+安卓2种客户端, 但是随着前端技术的不断探索和谷歌浏览器的推广, 通过套壳也好, js2native也好js这门语言被赋予了生成客户端的能力, 让js在这几年大火了起来, 比如阿里的weex, fb的react-native都可以直接用原生js的语法去生成
