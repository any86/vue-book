...
对于已经有成熟的互联网公司, 他们更看重的是用户体验,  自然对产品的流畅程度和对硬件的操作有了更高的要求, 

随着前端技术的不断探索, 套壳技术也进行了迭代 , 套壳在创业初期帮助公司解决了上线难的问题,  但是  js2nativejs这门语言被赋予了生成客户端的能力, 让js在这几年大火了起来, 比如阿里的weex, fb的react-native都可以直接用原生js的语法生成原生应用. 还有微信小程序, 其代码就是js. 这里要特别说下weex和微信小程序的api都是按照vue来设计的, 也就是学会了vue, 学weex和小程序就会非常快. 之所以这2者在用vue的api也正式因为vue设计的api比较易懂上手快.
